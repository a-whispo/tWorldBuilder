...
using TerrariaInGameWorldEditor.UI.UIElements.SearchGrid;
...
namespace TerrariaInGameWorldEditor.UI.TIGWEUI.TileSelector
{
    internal class SelectTileUI : TIGWEUI
    {
        ...
        private List<SelectTileProperty> _properties;
        ...
        public override void OnInitialize()
        {
            ...
            Append(preview);
            TIGWEImageButtonResizeable confirmBtn = new TIGWEImageButtonResizeable(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/Texture"));
            confirmBtn.TextureHover = ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/TextureHover");
            ...
            Append(confirmBtn);
            TIGWEImageResizeable previewBox = new TIGWEImageResizeable(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/Texture"), 8, 16);
            ...
            Append(previewBox);
            TIGWEImageResizeable border = new TIGWEImageResizeable(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/Texture"), 8, 16);
            ...
            TIGWEImageResizeable propertiesGridBorder = new TIGWEImageResizeable(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/MainScreenInnerBorder"), 6, 4);
            ...
            {
                return ((SelectTileProperty)item).Name.Contains(searchTerm, StringComparison.OrdinalIgnoreCase);
            });
            ...
            TIGWEButton tilePropertiesInfoButton = new TIGWEButton(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/InfoButton"));
            ...
            tilePropertiesInfoButton.SetHoverImage(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/InfoButtonHover"));
            ...
            // select tile grid
            TIGWEImageResizeable tileGridBorder = new TIGWEImageResizeable(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/MainScreenInnerBorder"), 6, 4);
            ...
            {
                return ((SelectTileItem)item).Name.Contains(searchTerm, StringComparison.OrdinalIgnoreCase);
            });
            tileGrid.ListPadding = 2;
            tileGrid.MarginLeft = 2;
            tileGrid.ManualSortMethod = (List<UIElement> items) =>
            {
                // compare by id
            ...
            TIGWEButton tileInfoButton = new TIGWEButton(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/InfoButton"));
            ...
            tileInfoButton.SetHoverImage(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/InfoButtonHover"));
            ...
            Task task = new Task(() =>
            {
                ...
                // add tile properties
                _properties = new List<SelectTileProperty>();
                foreach (PropertyInfo property in typeof(TileCopy).GetProperties())
                {
                    ...
                    _properties.Add(new SelectTileProperty(property, _currentTileCopy));
                }
        ...
        public void SetCurrentTileCopy(TileCopy tileCopy)
        {
            ...
            foreach (SelectTileProperty property in _properties)
            {
