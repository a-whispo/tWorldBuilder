...
namespace TerrariaInGameWorldEditor.UI.TIGWEUI.TileSelector
{
    internal class SelectTileItem : UIElement
    {
        ...
        private Item _item;
        private TIGWEImageResizeable _body = new TIGWEImageResizeable(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/Texture"));

        public SelectTileItem(int itemId)
        {
            // load item
        ...
        public override void MouseOver(UIMouseEvent evt)
        {
            ...
            _body.Texture = ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/TextureHover");
        }

        public override void MouseOut(UIMouseEvent evt)
        {
            base.MouseOut(evt);
            _body.Texture = ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/Texture");
        }
