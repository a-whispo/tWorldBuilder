...
namespace TerrariaInGameWorldEditor.UI.TIGWEUI.Save
{
    internal class SaveUI : TIGWEUI
    {
        ...
        public override void OnInitialize()
        {
            ...
            // path select button
            TIGWEButton pathSelect = new TIGWEButton(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/OpenFolder"));
            ...
            // path reset button
            TIGWEButton pathReset = new TIGWEButton(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/ResetPath"));
        ...
        private void SelectPath()
        {
            ...
            if (_selectFolderUI == null)
            {
                ...
                _selectFolderUI.OnSelectFolder += (UIDirectoryFolder folder) =>
                {
