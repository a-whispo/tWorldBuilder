...
namespace TerrariaInGameWorldEditor.UI.UIElements.Scrollbar
{
    internal class TIGWEScrollbar : UIScrollbar
    {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            UIElementsUtils.DrawTexture2DWithDimensions(texture.Value, dimensionsRectangle.ToRectangle(), spriteBatch);
            ...
            UIElementsUtils.DrawTexture2DWithDimensions(innerTexture.Value, handleRectangle.ToRectangle(), spriteBatch, default, 4, 8);
        }
    }
}
