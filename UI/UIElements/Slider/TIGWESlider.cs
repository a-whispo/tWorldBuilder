...
namespace TerrariaInGameWorldEditor.UI.UIElements.Slider
{
    internal class TIGWESlider : UIElement
    {
        ...
        public TIGWESlider(int width = 100)
        {
            ...
            _body = new TIGWEImageResizeable(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIImages/Texture"));
            _body.Width.Set(width, 0);
            _body.Height.Set(14, 0);
            _body.Top.Set(2, 0);
            Append(_body);

            _point = new UIImage(ModContent.Request<Texture2D>("TerrariaInGameWorldEditor/UI/UIElements/Slider/SliderPoint"));
